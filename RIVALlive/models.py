...
class ScoreDetail(models.Model):
    ...
    nearL0bonusMissile = models.IntegerField(verbose_name="Near L0 Bonus Missiles", default=0)
    nearL1normalMissile = models.IntegerField(verbose_name="Near L1 Missiles", default=0)
    nearL1bonusMissile = models.IntegerField(verbose_name="Near L1 Bonus Missiles", default=0)
    nearL2normalMissile = models.IntegerField(verbose_name="Near L2 Missiles", default=0)
    nearL2bonusMissile = models.IntegerField(verbose_name="Near L2 Bonus Missiles", default=0)
    nearL3normalMissile = models.IntegerField(verbose_name="Near L3 Missiles", default=0)
    nearL3bonusMissile = models.IntegerField(verbose_name="Near L3 Bonus Missiles", default=0)
    farL0normalMissile = models.IntegerField(verbose_name="Far L0 Missiles", default=0)
    farL0bonusMissile = models.IntegerField(verbose_name="Far L0 Bonus Missiles", default=0)
    farL1normalMissile = models.IntegerField(verbose_name="Far L1 Missiles", default=0)
    farL1bonusMissile = models.IntegerField(verbose_name="Far L1 Bonus Missiles", default=0)
    farL2normalMissile = models.IntegerField(verbose_name="Far L2 Missiles", default=0)
    farL2bonusMissile = models.IntegerField(verbose_name="Far L2 Bonus Missiles", default=0)
    farL3normalMissile = models.IntegerField(verbose_name="Far L3 Missiles", default=0)
    farL3bonusMissile = models.IntegerField(verbose_name="Far L3 Bonus Missiles", default=0)
